<?php
	...
	function wpvr_load_scripts() {
		...
		$js_localize_array = array(
			...
			'save_settings'                        => '<i class="fa fa-check"></i> ' . __( 'Save Settings' , WPVR_LANG ) ,
			'existing_videos_updated'              => __( 'Existing videos have been updated.' , WPVR_LANG ) ,
			'close_wizard'                         => __( 'Close this wizard' , WPVR_LANG ) ,
			'import_video_manually'                => __( 'Import a video manually' , WPVR_LANG ) ,
			...
			'start_by_saving_options'              => __( 'Your settings has changed! Start by saving them before updating the existing videos.' , WPVR_LANG ) ,
			...
			'license_reset_confirm'                => __( 'Do you really want to reset this addon license ?' , WPVR_LANG ) ,
			...
			'videos_processed'                     => __( 'videos processed' , WPVR_LANG ) ,
			'videos_added_successfully'            => __( 'videos added successfuly' , WPVR_LANG ) ,
			'videos_added'                         => __( 'videos added' , WPVR_LANG ) ,
			'videos_skipped'                       => __( 'videos skipped' , WPVR_LANG ) ,
			...
			'source_metrics'                       => __( 'Source Metrics' , WPVR_LANG ) ,
			'options_reset_confirm'                => __( 'Do you really want to reset options to default ?' , WPVR_LANG ) ,
			'addon_options_reset_confirm'          => __( "You're about to reset the following addon options " , WPVR_LANG ) ,
			'addon_options_reset_confirm_continue' => __( "Do you wish to continue?" , WPVR_LANG ) ,
			'addon_options_reset_done'             => __( "Addon options have been reset to default." , WPVR_LANG ) ,
			...
			'licenses_saved'                       => __( 'Licenses successfully saved' , WPVR_LANG ) ,
			...
			'loading'                              => wpvr_render_loading_message() ,
			'loading_raw'                          => __( 'Loading ...' , WPVR_LANG ) ,
			...
			'confirm_run_fillers'                  => __( 'Do you really want to run fillers on existing videos ? This may take some time.' , WPVR_LANG ) ,
			'update_existing_videos'                  => __( 'Update Existing Videos' , WPVR_LANG ) ,
			'make_sure_you_saved_options'          => __( 'Please make sure you have saved your editing on this screen before continuing.' , WPVR_LANG ) ,
