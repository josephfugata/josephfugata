jQuery(document).ready(function ($) {
    $.getScript(wpvr_globals.functions_js).done(function () {
        ...
        function wpvr_bulk_process_single(k, items, box, args) {
            ...
            //console.log(args.exec_time + ' / ' + args.total_exec_time);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    new_args.processed = parseInt(new_args.processed) + parseInt(new_args.count.total);
        ...
        function wpvr_init_video_popover(wrap) {
            ...
            var video_info = $('.wpvr_video_info_content', wrap).html();
            ...
            // console.log( wrap.parent('.wpvr_source_result').hasClass('.show_authors'));
            ...
            wrap.webuiPopover({
                ...
                width: 430,
                onShow: function ($el) {
                    $('.wpvr_video').css('opacity', 0.5);
                    wrap.css('opacity', 1);
                    wrap.addClass('hovered');
                },
                onHide: function ($el) {
                    wrap.removeClass('hovered');
                    $('.wpvr_video').css('opacity', 1);
                },
            });
        }

        $('.wpvr_has_video_info').each(function () {
            var wrap = $(this);
        ...
        $('.wp-admin.post-type-wpvr_source').each(function () {
            ...
            $(window).scroll(function () {
                ...
                // $('#wp-admin-bar-tribe-events').html( current_scroll + ' / ' + max_scroll);
