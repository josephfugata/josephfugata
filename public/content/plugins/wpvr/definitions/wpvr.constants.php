<?php
	...
	if ( ! defined( 'WPVR_ENABLE_RANDOMIZE_SOURCE_SEARCH' ) ) {
		define( 'WPVR_ENABLE_RANDOMIZE_SOURCE_SEARCH', false );
	}
	if ( ! defined( 'WPVR_DISABLE_WP_META_OPTIMIZATION' ) ) {
		define( 'WPVR_DISABLE_WP_META_OPTIMIZATION', false );
	}
	if ( ! defined( 'WPVR_DEFER_MAX_VALUE' ) ) {
		define( 'WPVR_DEFER_MAX_VALUE', 30 );
	}
	
	if ( ! defined( 'WPVR_ENABLE_TEMPLATER' ) ) {
		define( 'WPVR_ENABLE_TEMPLATER', true );
	}
	
	if ( ! defined( 'WPVR_ENABLE_DASHBOARD_CHARTS_OPTIMIZATION' ) ) {
		define( 'WPVR_ENABLE_DASHBOARD_CHARTS_OPTIMIZATION', false );
	}
	if ( ! defined( 'WPVR_ENABLE_TEST_VIDEO_INFO' ) ) {
		define( 'WPVR_ENABLE_TEST_VIDEO_INFO', true );
	}
	
	if ( ! defined( 'WPVR_UNASSIGNED_COLOR_HEX' ) ) {
		define( 'WPVR_UNASSIGNED_COLOR_HEX', '#444' );
	}
	...
	if ( ! defined( 'WPVR_VIDEO_TYPE_DEFAULT' ) ) {
		define( 'WPVR_VIDEO_TYPE_DEFAULT', 'wpvr_video2' );
	}
	...
	define( 'WPVR_DEFAULT_YOUTUBE_API_KEY', 'AIzaSyA5Zika6pMbGyqz_VEEgX8cO5o2OWN0k5w' );
	...
	if( !defined('WPVR_FORCE_EXTERNAL_THUMB_SSL') ){
		define('WPVR_FORCE_EXTERNAL_THUMB_SSL' , false );
	}
	
	if( !defined('WPVR_SOURCE_TABS_ENABLED') ){
		define('WPVR_SOURCE_TABS_ENABLED' , false );
	}