<?php
	...
	if( ! defined( 'WPVR_FORCE_ENGLISH_LANGUAGE' ) ) define( 'WPVR_FORCE_ENGLISH_LANGUAGE' , false );
	...
	if( ! defined( 'WPVR_LOGO_WHITE' ) ) define( 'WPVR_LOGO_WHITE' , WPVR_URL . "assets/images/logo.white.small.png" );
	
	/* CHANGELOG */
	if( ! defined( 'WPVR_CHANGELOG_URL_ENABLED' ) ) define( 'WPVR_CHANGELOG_URL_ENABLED' , TRUE );
	if( ! defined( 'WPVR_CHANGELOG_URL' ) ) define( 'WPVR_CHANGELOG_URL' , 'http://support.wpvideorobot.com/tutorials/wp-video-robot-1-9-15-released/' );
