<?php
	...
	/* Enable Sources Custom Fields Meta Box  */
	...
	define( 'WPVR_FORCE_EXTERNAL_THUMB_HARD_CROP', true );
	...
	/* Enable the templater engine of WPVR */
	...
	/* Video Info Popover */
	/* Set this to false to disable the video info popover on the entire WP Backend*/
	define( 'WPVR_ENABLE_TEST_VIDEO_INFO', true );
	
	/* Enable debug Mode */
	/* Set this to TRUE if you want to render the WP Meta Form metabox to manually edit/add/remove meta information */
	/* This is usually needed to be false when you cross 80kK videos */
	...
	/* Enable Youtube Search Random words Feature */
	define( 'WPVR_ENABLE_RANDOMIZE_SOURCE_SEARCH', false );
	
	
	/* Enable this if you encounter a long load time when visiting the plugin dashboard */
	/* This is usually needed when you cross 80K videos */
